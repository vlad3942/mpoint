...
-- Delete duplicate entires for key "IS_LEGACY_CALLBACK_FLOW" for PAL and OD
-- OD
DELETE FROM client.additionalproperty_tbl WHERE id=507;
DELETE FROM client.additionalproperty_tbl WHERE id=576;

-- PAL
DELETE FROM client.additionalproperty_tbl WHERE id=508;
DELETE FROM client.additionalproperty_tbl WHERE id=577;


-- OD
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES
('IS_LEGACY_CALLBACK_FLOW', 'false', true, 10018, 'client', 0);

-- PAL
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES
('IS_LEGACY_CALLBACK_FLOW', 'false', true, 10020, 'client', 0);
