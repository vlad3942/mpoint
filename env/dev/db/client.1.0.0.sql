...
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('password.SGD', '935jkndSL=xabtqSFh2+', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);