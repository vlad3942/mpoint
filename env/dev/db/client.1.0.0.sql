...
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('password.PHP', '42b5c09392e50702e05f29c37c75841a', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('HOST', 'gpmnl.gateway.mastercard.com', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
...
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('mid.SGD', 'TEST065004485703', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('username.SGD', 'merchant.TEST065004485703', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('password.SGD', '07FeZNGRt9xCdsIRiZ4Lqu6LT898ItHb', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('Notification-Secret.PHP', '379001F6E4852A832F8138F70190585B', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('Notification-Secret.HKD', '379001F6E4852A832F8138F70190585B', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);
INSERT INTO client.additionalproperty_tbl (key, value, enabled, externalid, type, scope) VALUES('Notification-Secret.SGD', '379001F6E4852A832F8138F70190585B', true, (SELECT ID FROM client.merchantaccount_tbl WHERE clientid = 10077 and pspid = 70), 'merchant', 2);