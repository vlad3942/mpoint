...
INSERT INTO client.routeconfig_tbl( routeid, name, capturetype, mid, username, password, enabled)
SELECT id, 'MPGS_OTHER_COUNTRY', 2, 'TEST048583918508', 'merchant.TEST048583918508', '78ebecfdcd194aac7c1e5fde0b584f40', enabled FROM client.route_tbl WHERE clientid = 10077 AND providerid = 72;
