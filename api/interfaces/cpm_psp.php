...
abstract class CPMPSP extends Callback implements Captureable, Refundable, Voiadable, Redeemable, Invoiceable
{
	...
	public function notifyClient($iStateId, array $vars) { parent::notifyClient($iStateId, $vars["additionaldata"], $vars["transact"], $vars["amount"], $vars["card-no"] , $vars["card-id"], $vars["expiry"]); }
