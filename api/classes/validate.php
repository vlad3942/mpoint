...
*/
	...
	public function valHMAC($mac, ClientConfig $obj_ClientConfig, ClientInfo $obj_ClientInfo, $orderno, $amount, $countryid,CountryConfig $obj_CountryConfig = null, $authToken = null)
	{
        ...
        $chkWithAuthTokenCustRefCustId = hash('sha512',$obj_ClientConfig->getID() . $orderno . $amount . $countryid . $mobile . $country_id . $obj_ClientInfo->getEMail() . $obj_ClientInfo->getDeviceID() . $authToken. $obj_ClientInfo->getCustomerRef() . $obj_ClientInfo->getProfileID() . $obj_ClientConfig->getSalt());
