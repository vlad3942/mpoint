...
//		echo $sql .'\n';			
    ...
    {
        $sql = "SELECT DISTINCT ON (C.id) C.id, Coalesce(RC.countryid, -1) AS countryid, R.providerid, C.enabled, RC.capturetype, C.id AS cardid, C.name, C.paymenttype, false AS walletid	
