...
class AMEXExpressCheckout extends CPMPSP
{
	...
	public function authorize(PSPConfig $obj_PSPConfig, $ticket) { throw new AMEXExpressCheckoutException("Method: authTicket is not supported by AMEX Express Checkout"); }
