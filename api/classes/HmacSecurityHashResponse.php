 ...
 * Project: server
 * Package:
 * File Name:HmacSecurityHashResponse.php
 */
...
/**
 * Class HmacSecurityHashResponse
 *
 * @package api\classes
...
class HmacSecurityHashResponse implements JsonSerializable, XMLSerializable
{
    ...
    /**
     * HmacSecurityHashResponse constructor.
     *
     * @param string $hmac
