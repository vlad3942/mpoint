...
class CebuPaymentCenter extends CPMPSP
{
    ...
    public function initialize(PSPConfig $obj_PSPConfig = NULL, $euaid=-1, $sc=false, $card_type_id=-1, $card_token='', $obj_BillingAddress = NULL, ClientInfo $obj_ClientInfo = NULL,$authToken = NULL, $aWalletCardSchemes = array())
    {
        if($card_type_id !== -1)
        {
