...
class Poli extends CPMPSP
{
	...
	public function cancel($amount = -1) { throw new PoliException("Method: cancel is not supported by POLi"); }
	...
	public function authorize(PSPConfig $obj_PSPConfig, $ticket,$clientInfo=null) { throw new PoliException("Method: authorize is not supported by POLi"); }
