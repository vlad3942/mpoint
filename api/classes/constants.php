...
abstract class Constants
{
	...
	*/
	...
	const iHARD_DECLINED_SUB_CODE_PAYMENT_CANCELLED = 2010305;
	const iHARD_DECLINED_SUB_CODE_DUPLICATE_TXN = 2010310;
	const iHARD_DECLINED_SUB_CODE_TXN_REJECTED_ISSUER = 2010314;
	const iHARD_DECLINED_SUB_CODE_EMI_UNAVAILABLE = 2010315;
	const iHARD_DECLINED_SUB_CODE_VOID_NOT_SUPPORTED = 2010316;
	const iHARD_DECLINED_SUB_CODE_CAPTURED_ALREADY = 2010317;
	const iHARD_DECLINED_SUB_CODE_INVALID_CAPTURE = 2010319;
	const iHARD_DECLINED_SUB_CODE_RECURRING_NOT_SUPPORTED = 2010321;
	const iHARD_DECLINED_SUB_CODE_STORED_CARD_DISABLED = 2010322;
	const iHARD_DECLINED_SUB_CODE_TXN_GENERATION_FAIL = 2010325;
	const iHARD_DECLINED_SUB_CODE_INSTALLMENT_DISABLED = 2010326;
	const iHARD_DECLINED_SUB_CODE_TICKET_ISSUE_FAIL = 2010327;
	const iHARD_DECLINED_SUB_CODE_CUP_SIGN_FAIL = 2010328;
	const iHARD_DECLINED_SUB_CODE_ISSUE_BANK_UNAVAILABLE = 2010330;
	const iHARD_DECLINED_SUB_CODE_TXN_EXCEED_LIMIT = 2010331;
	const iHARD_DECLINED_SUB_CODE_UNVOIDABLE = 2010332;
	const iHARD_DECLINED_SUB_CODE_UNREFUNDABLE = 2010333;
	const iHARD_DECLINED_SUB_CODE_AMOUNT_LIMIT_EXCEEDS = 2010334;
