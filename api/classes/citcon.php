...
class Citcon extends CPMPSP
{
	...
	public function refund($iAmount=-1) { throw new CitconException("Method: refund is not supported by Citcon"); }
	public function void($iAmount=-1) { throw new CitconException("Method: void is not supported by Citcon"); }
