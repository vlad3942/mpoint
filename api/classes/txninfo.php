...
class TxnInfo
{
    ...
    */
     ...
     * @param CountryConfig $oCC
     * @param CurrencyConfig|null $oCR
     ...
     * @param int $ac Boolean Flag indicating whether Auto Capture should be used for the transaction
     ...
     * @param int $cptamt The Full amount that has been captured for the Transaction
     * @param int $cardid
     * @param int $walletid
     * @param string $mask
     * @param string $expiry
     * @param string $token
     * @param string $authOriginalData
     * @param string $approvalActionCode
     * @param string $createdTimestamp
     * @param string $virtualtoken
     * @param array $additionalData
     * @param array $aExternalRef External Reference Ids
     * @param integer $ofAmt Offered DCC Amount
     * @param CurrencyConfig|null $oFCR Offered DCC Currency
     * @param int $fconversionRate Offered DCC Conversion Rate
...
//		echo $sql;
    ...
    {
		$aHardDeclined = array(
			Constants::iHARD_DECLINED_SUB_CODE_PAYMENT_CANCELLED,
			Constants::iHARD_DECLINED_SUB_CODE_DUPLICATE_TXN,
			Constants::iHARD_DECLINED_SUB_CODE_TXN_REJECTED_ISSUER,
			Constants::iHARD_DECLINED_SUB_CODE_EMI_UNAVAILABLE,
			Constants::iHARD_DECLINED_SUB_CODE_VOID_NOT_SUPPORTED,
			Constants::iHARD_DECLINED_SUB_CODE_CAPTURED_ALREADY,
			Constants::iHARD_DECLINED_SUB_CODE_INVALID_CAPTURE,
			Constants::iHARD_DECLINED_SUB_CODE_RECURRING_NOT_SUPPORTED,
			Constants::iHARD_DECLINED_SUB_CODE_STORED_CARD_DISABLED,
			Constants::iHARD_DECLINED_SUB_CODE_TXN_GENERATION_FAIL,
			Constants::iHARD_DECLINED_SUB_CODE_INSTALLMENT_DISABLED,
			Constants::iHARD_DECLINED_SUB_CODE_TICKET_ISSUE_FAIL,
			Constants::iHARD_DECLINED_SUB_CODE_CUP_SIGN_FAIL,
			Constants::iHARD_DECLINED_SUB_CODE_ISSUE_BANK_UNAVAILABLE,
			Constants::iHARD_DECLINED_SUB_CODE_TXN_EXCEED_LIMIT,
			Constants::iHARD_DECLINED_SUB_CODE_UNVOIDABLE,
			Constants::iHARD_DECLINED_SUB_CODE_UNREFUNDABLE,
			Constants::iHARD_DECLINED_SUB_CODE_AMOUNT_LIMIT_EXCEEDS
		);
