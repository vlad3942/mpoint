...
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type, scope) select 'MAX_DOWNLOAD_FILE_LIMIT', '1', id, 'merchant',2 from client.merchantaccount_tbl WHERE clientid=10069 AND pspid=52;
