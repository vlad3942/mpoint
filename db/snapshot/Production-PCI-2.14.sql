...
-- UATP
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) VALUES ('SETTLEMENT_BATCH_LIMIT', '400', (SELECT id FROM Client.MerchantAccount_Tbl WHERE clientid = 10069 and pspid = 52), 'merchant');
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) VALUES ('SETTLEMENT_BATCH_LIMIT', '300', (SELECT id FROM Client.MerchantAccount_Tbl WHERE clientid = 10069 and pspid = 50), 'merchant');
