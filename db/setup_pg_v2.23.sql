...
INSERT INTO System.PSP_Tbl (id, name,system_type) VALUES ( 66, 'GrabPay',4);
INSERT INTO System.PSPCurrency_Tbl (currencyid, pspid, name) VALUES (608,66,'PHP');
INSERT INTO system.Card_tbl (id, name, position, minlength, maxlength, cvclength, paymenttype) VALUES (89, 'GrabPay', 23, -1, -1, -1, 4);
INSERT INTO System.CardPricing_Tbl (cardid, pricepointid) SELECT 89, id FROM System.PricePoint_Tbl WHERE amount = -1 AND currencyid = 608;
INSERT INTO system.cardprefix_tbl (cardid, min, max) VALUES (89, 0, 0);
INSERT INTO System.PSPCard_Tbl (cardid, pspid) VALUES (89, 66);

INSERT INTO Client.MerchantAccount_Tbl (clientid, pspid, name, username, passwd) VALUES (<clientid>, 66, 'dbb00e18-83ee-49cf-b54d-2707a069b3e4', '0112218e-dda0-4ca8-8489-65a3d28abd69', 'apWSvBQj_evmVfzY');
INSERT INTO Client.MerchantSubAccount_Tbl (accountid, pspid, name) VALUES (<accountid>, 66, '-1');
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type,scope) select 'CLIENT_ID', '14c3e87ce4e04e82954fd78cea2b3a64', id, 'merchant',1 from client.merchantaccount_tbl WHERE clientid=<> AND pspid=66;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type,scope) select 'CLIENT_SECRET', 'dcyDLGEYkeLZA1YM', id, 'merchant',1 from client.merchantaccount_tbl WHERE clientid=<> AND pspid=66;
INSERT INTO client.cardaccess_tbl (clientid, cardid, pspid, countryid, stateid, enabled) VALUES (<>>, 89, 66, 640, 1, true);
/* ========== Grab Pay Integration = STARTS ========== */
