...
INSERT INTO Client.CardAccess_Tbl (clientid, cardid, pspid) SELECT <client ID>, PC.cardid, PC.pspid FROM System.PSPCard_Tbl PC, Client.Client_Tbl Cl WHERE PC.cardid IN (95,40) AND PC.pspid ='40' GROUP BY PC.cardid, PC.pspid;
