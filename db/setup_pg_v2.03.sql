...
-- PSP tbl config --
INSERT INTO System.PSP_Tbl (id, name,system_type, capture_method) VALUES (52, 'Chase Payment',2,6);
...
UPDATE Client.MerchantAccount_Tbl set username = 'nconline1',passwd = 'nconline1',name = 'Chase Payment' WHERE clientid = 10007 AND pspid = 52;
...
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'USERNAME.SID', '355426', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'PASSWORD.SID', 'CELLAIR2', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'CHASE_SFTP_USERNAME', 'SV3PX7R4', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'CHASE_SFTP_PASSWORD', 'W9ajOClR', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'CHASE_FILE_PREFIX', 'CPM', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MERCHANT.CITY', 'USA', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;

INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.USD', '900183', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.CAD', '253997', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.AUD', '322446', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.HKD', '336032', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.JPY', '348045', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.ZAR', '425272', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.GBP', '732214', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.EUR', '925529', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.NZD', '984047', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.SEK', '984351', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.TWD', '097004', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
INSERT INTO client.additionalproperty_tbl (key, value, externalid, type) select 'MID.RUB', '097003', id, 'merchant' from client.merchantaccount_tbl WHERE clientid=10007 AND pspid=52;
