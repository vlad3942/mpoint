...
class CancelCallbackAPITest extends baseAPITest
{
    ...
    protected function getCallbackDoc($transactionId, $orderId)
    {
        ...
        $xml .= '<card type-id="8" />';
        $xml .= '</transaction>';
        $xml .= '<status code="2002">The resource was successfully created.</status>';
    ...
    public function testSuccessfulCallbackAccepted()
    {
        ...
        $this->queryDB("INSERT INTO log.message_tbl (txnid, stateid) VALUES (1001001, 2002)");
