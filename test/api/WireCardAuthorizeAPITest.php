...
class WireCardAuthorizeAPITest extends AuthorizeAPITest
{
    ...
    public function testSuccessfulAuthorizeWithSubCode()
    {
        ...
        $this->markTestIncomplete("Failed asserting that '500' matches expected 200.");
        $pspID=Constants::iWIRE_CARD_PSP;
        $sCallbackURL = $this->_aMPOINT_CONN_INFO["protocol"] ."://". $this->_aMPOINT_CONN_INFO["host"]. "/_test/simulators/mticket/callback.php";
        ...
        $this->queryDB("INSERT INTO EndUser.Account_Tbl (id, countryid, externalid, mobile, mobile_verified, passwd, enabled) VALUES (5001, 100, 'abcExternal', '29612109', TRUE, 'profilePassSubCode', TRUE)");
        ...
        $xml = $this->getAuthDoc(113, 1100, 1001001, 5000, 'profilePassSubCode');
        ...
        $this->assertEquals(200, $iStatus);
        $this->assertEquals('<?xml version="1.0" encoding="UTF-8"?><root><status code="2000" sub-code="2000123">Payment authorized</status></root>', $sReplyBody);
