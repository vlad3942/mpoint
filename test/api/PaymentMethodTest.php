...
class PaymentMethodTest extends baseAPITest
{
    ...
    public function testSuccessGetPaymentMethodByOrder()
    {
        ...
        $readOnlyRepo = new ReadOnlyConfigRepository($this->_OBJ_DB,$obj_TxnInfo->getClientConfig());
        ...
        if($obj_PaymentMethodResponse instanceof RoutingServiceResponse)
        {
            ...
            $obj_SR = $readOnlyRepo->getCardConfigurationsByCardIds( $obj_TxnInfo,$this->_OBJ_TXT, $obj_PaymentMethods);
