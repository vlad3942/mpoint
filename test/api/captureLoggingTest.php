...
class CaptureLoggingTest extends baseAPITest
{
	...
	public function testPositiveScenarioCaptureLogging()
	{
		...
		$this->queryDB("INSERT INTO Log.txnpassbook_Tbl (id,transactionid,amount,currencyid,requestedopt,performedopt,status) VALUES (104,1001001, 5000,208,". Constants::iCaptureRequested. ",NULL,'done')");
		$this->queryDB("INSERT INTO Log.txnpassbook_Tbl (id,transactionid,amount,currencyid,requestedopt,performedopt,status,extref) VALUES (105,1001001, 5000,208,NULL,". Constants::iPAYMENT_CAPTURED_STATE. ",'inprogress',104)");
