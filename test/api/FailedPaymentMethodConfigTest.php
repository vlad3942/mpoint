...
class FailedPaymentMethodConfigTest extends baseAPITest
{
    ...
    public function testSuccessGetFailedPaymentMethods()
    {
        ...
        $this->assertStringContainsString('<retry_attempts><retry_attempt><transaction_id>1001001</transaction_id><card_id>8</card_id><payment_states><payment_state>2000</payment_state></payment_states><card_category_id>1</card_category_id></retry_attempt></retry_attempts>', $xml);
    }


    public function testSuccessGetFraudFailedPaymentMethods()
    {
        $this->queryDB("INSERT INTO Client.Client_Tbl (id, flowid, countryid, name, username, passwd) VALUES (10099, 1, 100, 'Test Client', 'Tuser', 'Tpass')");
        $this->queryDB("INSERT INTO Client.URL_Tbl (clientid, urltypeid, url) VALUES (10099, 4, 'http://mpoint.local.cellpointmobile.com/')");
        $this->queryDB("INSERT INTO Client.Account_Tbl (id, clientid) VALUES (1100, 10099)");
        ...
        $this->queryDB("INSERT INTO Log.txnpassbook_Tbl (id,transactionid,amount,currencyid,requestedopt,performedopt,status,clientid) VALUES (102,1001001, 5000,208,". Constants::iAuthorizeRequested. ",NULL,'done',10099)");
        $this->queryDB("INSERT INTO Log.txnpassbook_Tbl (id,transactionid,amount,currencyid,requestedopt,performedopt,status,clientid) VALUES (103,1001001, 5000,208,NULL,". Constants::iPAYMENT_ACCEPTED_STATE. ",'error',10099)");
        $this->queryDB("INSERT INTO Log.MESSAGE_TBL (txnid,stateid) VALUES (1001001, 3015)");
        ...
        $this->assertInstanceOf(FailedPaymentMethodConfig::class, $obj_FailedPaymentMethod);
        $this->assertStringContainsString('<retry_attempts><retry_attempt><transaction_id>1001001</transaction_id><card_id>8</card_id><payment_states><payment_state>2000</payment_state><payment_state>3015</payment_state></payment_states><card_category_id>1</card_category_id></retry_attempt></retry_attempts>', $xml);
    }
