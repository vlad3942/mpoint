...
class PaymayaAcqAuthTest extends AuthorizeAPITest
{
    public function testSuccessfulAuthorize()
    {
        ...
        $this->queryDB("INSERT INTO EndUser.Card_Tbl (id, accountid, cardid, pspid, mask, expiry, preferred, clientid, name, ticket, card_holder_name) VALUES (61775, $endUserAccountId, $cardId, $pspID, '542606******4979', '12/21', TRUE, $clientId, NULL, '1767989 ### CELLPOINT ### 100 ### DKK', NULL);");
        ...
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, keywordid, pspid, euaid, countryid, orderid, callbackurl, amount, ip, enabled, currencyid,sessionid,convertedamount,convertedcurrencyid) VALUES (1001001, 100, $clientId, $accountId, 1,  $pspID, $endUserAccountId, $countryId, '103-1418291', '". $sCallbackURL ."', $amount, '127.0.0.1', TRUE, $currencyId, 1,$amount,$currencyId)");

        $xml = $this->getAuthDoc($clientId, $accountId, 1001001, $amount, $profilePass, 0, '', null, null, $cardId);
