...
class DelCardAPIValidationTest extends baseAPITest
{
    ...
    public function testNotAllowedOngoingTransaction()
    {
        ...
        $this->queryDB("INSERT INTO EndUser.CLAccess_Tbl (clientid, accountid) VALUES (113, 5001)");
        $this->queryDB("INSERT INTO EndUser.Card_Tbl (id, accountid, cardid, pspid, mask, expiry, preferred, clientid, name, ticket, card_holder_name) VALUES (61775, 5001, 2, 2, '5019********3742', '/', true, 113, NULL, '1767989 ### CELLPOINT ### 100 ### DKK', NULL);");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, euaid, countryid, amount, ip, created, enabled, currencyid,convertedamount,convetredcurrencyid) VALUES (1001001, 100, 113, 1100, 5001, 100, 5000, '127.0.0.1', '" . $authTime . "', TRUE, 208,5000,208)");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, euaid, countryid, amount, ip, created, enabled, currencyid,convertedamount,convetredcurrencyid) VALUES (1001002, 100, 113, 1100, 5001, 100, 5000, '127.0.0.1', '" . $authTime . "', TRUE, 208,5000,208)");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1001001, " . Constants::iPAYMENT_ACCEPTED_STATE . ")");
        $xml = $this->getDelCardDoc(113, 1100, 61775, 'abcExternal', 'profilePass', 5001, 'Tpass');
    ...
    public function testDifferentEUAOngoingTransaction()
    {
        ...
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, euaid, countryid, amount, ip, created, enabled, currencyid,convertedamount,convetredcurrencyid) VALUES (1001002, 100, 113, 1100, 5002, 100, 5000, '127.0.0.1', '" . $authTime . "', TRUE, 208,5000,208)");
        //$this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1001001, ". Constants::iPAYMENT_ACCEPTED_STATE. ")");
    ...
    public function testExpiredOngoingTransaction()
    {
        ...
        $this->queryDB("INSERT INTO EndUser.CLAccess_Tbl (clientid, accountid) VALUES (113, 5001)");
        $this->queryDB("INSERT INTO EndUser.Card_Tbl (id, accountid, cardid, pspid, mask, expiry, preferred, clientid, name, ticket, card_holder_name) VALUES (61775, 5001, 2, 2, '5019********3742', '/', true, 113, NULL, '1767989 ### CELLPOINT ### 100 ### DKK', NULL);");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, countryid, amount, ip, created, enabled, currencyid,convertedamount,convetredcurrencyid) VALUES (1001001, 100, 113, 1100, 100, 5000, '127.0.0.1', '" . $authTime . "', TRUE, 208,5000,208)");
