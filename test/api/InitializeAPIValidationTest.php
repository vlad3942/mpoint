...
class InitializeAPIValidationTest extends baseAPITest
{
    ...
    public function testSplitPaymentCombinations()
	{
		...
		$this->queryDB("INSERT INTO Client.URL_Tbl (clientid, urltypeid, url) VALUES (10099, 4, 'http://mpoint.local.cellpointmobile.com/')");
		$this->queryDB("INSERT INTO Client.Account_Tbl (id, clientid) VALUES (1100, 10099)");
        $this->queryDB("insert into client.services_tbl (clientid, dcc_enabled, mcp_enabled, pcc_enabled, fraud_enabled, tokenization_enabled, splitpayment_enabled, callback_enabled, void_enabled, mpi_enabled, legacy_flow_enabled, enabled) values (10099, false, false, false, false, false, true, false, false, false, true, true)");
