...
class CallbackMessageRequestTest extends baseAPITest
{
    ...
    public function setUp() : void
    {
        ...
        $stateInfo = new StateInfo(2010, 20103, 'Transaction Failed',"SGS-070041: Lost card","N:41");
