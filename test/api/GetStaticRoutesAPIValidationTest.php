...
class GetStaticRoutesAPIValidationTest extends baseAPITest
{
    ...
    public function testBadRequestUndefinedClient()
    {
        ...
        $this->assertStringContainsString('<status code="1">Undefined Client ID</status>', $sReplyBody);
    }
    ...
    public function testBadRequestInvalidClient()
    {
        ...
        $this->assertEquals(400, $iStatus);
		$this->assertStringContainsString('<status code="2">Invalid Client ID</status>', $sReplyBody);
    }
    ...
    public function testBadRequestUnknownClient()
    {
        ...
        $this->assertEquals(400, $iStatus);
        $this->assertStringContainsString('<status code="3">Unknown Client ID</status>', $sReplyBody);
    }
    ...
    public function testBadRequestDisabledClient()
    {
        ...
        $this->assertEquals(400, $iStatus);
        $this->assertStringContainsString('<?xml version="1.0" encoding="UTF-8"?><route_response><status code="4">Client Disabled</status></route_response>', $sReplyBody);
    }
	...
	public function testSuccessPaymentMethods()
    {
		...
		$this->assertStringContainsString('<route><card_type_id>8</card_type_id><country_id>200</country_id><currency_id>840</currency_id><psp_id>17</psp_id><enabled>true</enabled><psp_type>1</psp_type></route>', $sReplyBody);
        $this->assertStringContainsString('<route><card_type_id>7</card_type_id><country_id>608</country_id><currency_id></currency_id><psp_id>18</psp_id><enabled>true</enabled><psp_type>1</psp_type></route>', $sReplyBody);
        $this->assertStringContainsString('<route><card_type_id>8</card_type_id><country_id>608</country_id><currency_id></currency_id><psp_id>18</psp_id><enabled>true</enabled><psp_type>1</psp_type></route>', $sReplyBody);
        $this->assertStringContainsString('<route><card_type_id>7</card_type_id><country_id>200</country_id><currency_id>840</currency_id><psp_id>17</psp_id><enabled>true</enabled><psp_type>1</psp_type></route>', $sReplyBody);
