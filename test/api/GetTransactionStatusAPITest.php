...
class GetTransactionStatusAPITest extends baseAPITest
{
    ...
    {
        $xml = $this->getGetTransactionStatusDoc("",10099);
    ...
    public function testGetTransactionStatusSuccessWithDCC()
    {
        ...
        $this->queryDB("INSERT INTO EndUser.Card_Tbl (id, accountid, cardid, pspid, mask, expiry, preferred, clientid, name, ticket, card_holder_name) VALUES (61775, 5001, 2, $pspID, '501910******3742', '06/24', TRUE, 10099, NULL, '1767989 ### CELLPOINT ### 100 ### DKK', NULL);");
        $this->queryDB("INSERT INTO log.session_tbl (id, clientid, accountid, currencyid, countryid, stateid, orderid, amount, mobile, deviceid, ipaddress, externalid, sessiontypeid) VALUES (1, 10099, 1100, 208, 100, 4001, '103-1418291', 5000, 9876543210, '', '127.0.0.1', -1, 1);");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, keywordid, pspid, euaid, operatorid, countryid, orderid, callbackurl, amount, ip, enabled, currencyid,sessionid,convertedamount,convertedcurrencyid,conversionrate,expiry, created) VALUES (1001001, 100, 10099, 1100, 1,  $pspID, 5001, 10000, 100, '103-1418291', '". $sCallbackURL ."', 5000, '127.0.0.1', TRUE, 208, 1,10000,840,2,'12/21','2021-01-18 13:09:28')");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1001001, ". Constants::iPAYMENT_INIT_WITH_PSP_STATE .")");
        $this->queryDB("INSERT INTO Log.Address_Tbl (first_name,last_name ,street, street2, city, state, country, zip, reference_id, reference_type, mobile_country_id, mobile, email) VALUES ('test','test', 'test', 'test', 'test', 'test', 'test', '411023', '1001001', 'transaction','200','test@test.com','8888888888')");

        $xml = $this->getGetTransactionStatusDoc(1001001,10099,1);
        ...
        $this->assertEquals(200, $iStatus);
        $this->assertEquals('<?xml version="1.0" encoding="UTF-8"?><root><transaction id="1001001" mpoint-id="1001001" order-no="103-1418291" accoutid="1100" clientid="10099" language="gb"  card-id="0" psp-id="18" payment-method-id="1"   session-id="1" session-type="1" extid="" approval-code="" walletid="-1" txn-type-id="100"><amount country-id="100" currency="840" symbol="$" format="{PRICE} {CURRENCY}" pending = "5000"  currency-code = "USD" decimals = "2" conversationRate = "2">10000</amount><initialize_amount country-id="1001001" currency="208" symbol="Kr." format="{PRICE} {CURRENCY}" pending = "5000"  currency-code = "DKK" decimals = "2">5000</initialize_amount><card-expiry>12/21</card-expiry><card-name>System Record</card-name><psp-name>Wire Card</psp-name><accept-url></accept-url><cancel-url></cancel-url><css-url></css-url><logo-url></logo-url><google-analytics-id></google-analytics-id><form-method></form-method><createdDate>2021-01-18</createdDate><createdTime>13:09:28</createdTime><status></status><sign>17c748674d4f783cf7207ff4e2b9c617</sign><client-info language="gb" platform=""><mobile operator-id="10000" country-id="100"></mobile><email></email><customer-ref></customer-ref><device-id></device-id></client-info><address><first-name>test</first-name><last-name>test</last-name><street>test</street><street2>test</street2><postal-code>411023</postal-code><city>test</city><state>test</state><country><name></name><code>0</code><alpha2code></alpha2code><alpha3code></alpha3code></country><mobile idc="1">test@test.com</mobile><email>8888888888</email></address></transaction><payment_status>Pending</payment_status><stored-card><card-id>61775</card-id><card-mask>501910******3742</card-mask><card-expiry>06/24</card-expiry><card-type>2</card-type></stored-card></root>', $sReplyBody);
    }

    public function testLinkedTransactionsWithComplete()
    {
        ...
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1, ". Constants::iPAYMENT_ACCEPTED_STATE. ")");
        ...
        $this->queryDB("INSERT INTO log.additional_data_tbl(name, value, type, externalid) VALUES('linked_txn_id', '1001001', 'Transaction','1')");
        $this->queryDB("INSERT INTO log.additional_data_tbl(name, value, type, externalid) VALUES('linked_txn_id', '1', 'Transaction','1001001')");
        ...
        $this->assertEquals(200, $iStatus);
        $this->assertEquals('<?xml version="1.0" encoding="UTF-8"?><root><transaction id="1001001" mpoint-id="1001001" order-no="103-1418291" accoutid="1100" clientid="10099" language="gb"  card-id="0" psp-id="19" payment-method-id="1"   session-id="1" session-type="2" extid="" approval-code="" walletid="-1" txn-type-id="100"><amount country-id="100" currency="208" symbol="Kr." format="{PRICE} {CURRENCY}" pending = "0"  currency-code = "DKK" decimals = "2" conversationRate = "1">5000</amount><card-expiry>12/21</card-expiry><card-name>System Record</card-name><psp-name>DSB</psp-name><accept-url></accept-url><cancel-url></cancel-url><css-url></css-url><logo-url></logo-url><google-analytics-id></google-analytics-id><form-method></form-method><createdDate>2021-01-18</createdDate><createdTime>13:09:28</createdTime><status><status-message id = "2000" position = "1">Payment authorized by PSP</status-message></status><sign>257e89dffd3e6ff7db2fed0182ee54ef</sign><client-info language="gb" platform=""><mobile operator-id="10000" country-id="100"></mobile><email></email><customer-ref></customer-ref><device-id></device-id></client-info><additional-data><param name="linked_txn_id">1</param></additional-data></transaction><payment_status>Complete</payment_status><linked_transactions><transaction_details><id>1001001</id><status>Complete</status></transaction_details><transaction_details><id>1</id><status>Complete</status></transaction_details></linked_transactions><stored-card><card-id>61775</card-id><card-mask>501910******3742</card-mask><card-expiry>06/24</card-expiry><card-type>1</card-type></stored-card></root>', $sReplyBody);
    }

    public function testLinkedTransactionsWithPending()
    {
        $sCallbackURL = $this->_aMPOINT_CONN_INFO["protocol"] . "://" . $this->_aMPOINT_CONN_INFO["host"] . "/_test/simulators/mticket/callback.php";
        $pspID = Constants::iDSB_PSP;
        ...
        $this->queryDB("INSERT INTO Client.CardAccess_Tbl (clientid, cardid, pspid, enabled, stateid) VALUES (10099, 1, $pspID, true, 1)");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, orderid, typeid, clientid, accountid, countryid, pspid, callbackurl, amount, ip, enabled, keywordid, sessionid,convertedamount) VALUES (1, '900-55150298', 100, 10099, 1100, 100, $pspID, '" . $sCallbackURL . "', 5000, '127.0.0.1', TRUE, 1, 1,5000)");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1, ". Constants::iPAYMENT_INIT_WITH_PSP_STATE. ")");
        ...
        $this->assertEquals(200, $iStatus);
        $this->assertEquals('<?xml version="1.0" encoding="UTF-8"?><root><transaction id="1001001" mpoint-id="1001001" order-no="103-1418291" accoutid="1100" clientid="10099" language="gb"  card-id="0" psp-id="19" payment-method-id="1"   session-id="1" session-type="2" extid="" approval-code="" walletid="-1" txn-type-id="100"><amount country-id="100" currency="208" symbol="Kr." format="{PRICE} {CURRENCY}" pending = "10000"  currency-code = "DKK" decimals = "2" conversationRate = "1">5000</amount><card-expiry>12/21</card-expiry><card-name>System Record</card-name><psp-name>DSB</psp-name><accept-url></accept-url><cancel-url></cancel-url><css-url></css-url><logo-url></logo-url><google-analytics-id></google-analytics-id><form-method></form-method><createdDate>2021-01-18</createdDate><createdTime>13:09:28</createdTime><status></status><sign>257e89dffd3e6ff7db2fed0182ee54ef</sign><client-info language="gb" platform=""><mobile operator-id="10000" country-id="100"></mobile><email></email><customer-ref></customer-ref><device-id></device-id></client-info><additional-data><param name="linked_txn_id">1</param></additional-data></transaction><payment_status>Pending</payment_status><linked_transactions><transaction_details><id>1001001</id><status>Pending</status></transaction_details><transaction_details><id>1</id><status>Pending</status></transaction_details></linked_transactions><stored-card><card-id>61775</card-id><card-mask>501910******3742</card-mask><card-expiry>06/24</card-expiry><card-type>1</card-type></stored-card></root>', $sReplyBody);
    }

    public function testLinkedTransactionsWithFailed()
    {
        $sCallbackURL = $this->_aMPOINT_CONN_INFO["protocol"] . "://" . $this->_aMPOINT_CONN_INFO["host"] . "/_test/simulators/mticket/callback.php";
        $pspID = Constants::iDSB_PSP;
        ...
        $this->queryDB("INSERT INTO Client.CardAccess_Tbl (clientid, cardid, pspid, enabled, stateid) VALUES (10099, 1, $pspID, true, 1)");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, orderid, typeid, clientid, accountid, countryid, pspid, callbackurl, amount, ip, enabled, keywordid, sessionid,convertedamount) VALUES (1, '900-55150298', 100, 10099, 1100, 100, $pspID, '" . $sCallbackURL . "', 5000, '127.0.0.1', TRUE, 1, 1,5000)");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1, ". Constants::iPAYMENT_REJECTED_STATE. ")");
        ...
        $this->assertEquals(200, $iStatus);
        $this->assertEquals('<?xml version="1.0" encoding="UTF-8"?><root><transaction id="1001001" mpoint-id="1001001" order-no="103-1418291" accoutid="1100" clientid="10099" language="gb"  card-id="0" psp-id="19" payment-method-id="1"   session-id="1" session-type="2" extid="" approval-code="" walletid="-1" txn-type-id="100"><amount country-id="100" currency="208" symbol="Kr." format="{PRICE} {CURRENCY}" pending = "10000"  currency-code = "DKK" decimals = "2" conversationRate = "1">5000</amount><card-expiry>12/21</card-expiry><card-name>System Record</card-name><psp-name>DSB</psp-name><accept-url></accept-url><cancel-url></cancel-url><css-url></css-url><logo-url></logo-url><google-analytics-id></google-analytics-id><form-method></form-method><createdDate>2021-01-18</createdDate><createdTime>13:09:28</createdTime><status><status-message id = "2010" position = "1">Payment rejected by PSP</status-message></status><sign>257e89dffd3e6ff7db2fed0182ee54ef</sign><client-info language="gb" platform=""><mobile operator-id="10000" country-id="100"></mobile><email></email><customer-ref></customer-ref><device-id></device-id></client-info><additional-data><param name="linked_txn_id">1</param></additional-data></transaction><payment_status>Failed</payment_status><linked_transactions><transaction_details><id>1001001</id><status>Failed</status></transaction_details><transaction_details><id>1</id><status>Failed</status></transaction_details></linked_transactions><stored-card><card-id>61775</card-id><card-mask>501910******3742</card-mask><card-expiry>06/24</card-expiry><card-type>1</card-type></stored-card></root>', $sReplyBody);
    }

    public function testLinkedTransactionsWithFailed2()
    {
        $sCallbackURL = $this->_aMPOINT_CONN_INFO["protocol"] . "://" . $this->_aMPOINT_CONN_INFO["host"] . "/_test/simulators/mticket/callback.php";
        $pspID = Constants::iDSB_PSP;
        ...
        $this->queryDB("INSERT INTO EndUser.Account_Tbl (id, countryid, externalid, mobile, mobile_verified, passwd, enabled) VALUES (5001, 100, 'abcExternal', '29612109', TRUE, 'profilePass', TRUE)");
        $this->queryDB("INSERT INTO EndUser.CLAccess_Tbl (clientid, accountid) VALUES (10099, 5001)");
        $this->queryDB("INSERT INTO log.session_tbl (id, clientid, accountid, currencyid, countryid, stateid, orderid, amount, mobile, deviceid, ipaddress, externalid, sessiontypeid) VALUES (1, 10099, 1100, 208, 100, 4001, '103-1418291', 5000, 9876543210, '', '127.0.0.1', -1, 2);");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, keywordid, pspid, euaid, operatorid, countryid, orderid, callbackurl, amount, ip, enabled, currencyid,sessionid,convertedamount,convertedcurrencyid,expiry,created) VALUES (1001001, 100, 10099, 1100, 1,  $pspID, 5001, 10000, 100, '103-1418291', '". $sCallbackURL ."', 5000, '127.0.0.1', TRUE, 208, 1,5000,208,'12/21','2021-01-18 13:09:28')");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1001001, ". Constants::iINPUT_VALID_STATE. ")");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1001001, ". Constants::iPAYMENT_INIT_WITH_PSP_STATE. ")");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1001001, ". Constants::iPAYMENT_REJECTED_STATE. ")");
        ...
        $this->queryDB("INSERT INTO Client.CardAccess_Tbl (clientid, cardid, pspid, enabled, stateid) VALUES (10099, 1, $pspID, true, 1)");
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, orderid, typeid, clientid, accountid, countryid, pspid, callbackurl, amount, ip, enabled, keywordid, sessionid,convertedamount) VALUES (1, '900-55150298', 100, 10099, 1100, 100, $pspID, '" . $sCallbackURL . "', 5000, '127.0.0.1', TRUE, 1, 1,5000)");
        $this->queryDB("INSERT INTO Log.Message_Tbl (txnid, stateid) VALUES (1, ". Constants::iPAYMENT_PENDING_STATE. ")");
        ...
        $this->assertEquals(200, $iStatus);
        $this->assertEquals('<?xml version="1.0" encoding="UTF-8"?><root><transaction id="1001001" mpoint-id="1001001" order-no="103-1418291" accoutid="1100" clientid="10099" language="gb"  card-id="0" psp-id="19" payment-method-id="1"   session-id="1" session-type="2" extid="" approval-code="" walletid="-1" txn-type-id="100"><amount country-id="100" currency="208" symbol="Kr." format="{PRICE} {CURRENCY}" pending = "0"  currency-code = "DKK" decimals = "2" conversationRate = "1">5000</amount><card-expiry>12/21</card-expiry><card-name>System Record</card-name><psp-name>DSB</psp-name><accept-url></accept-url><cancel-url></cancel-url><css-url></css-url><logo-url></logo-url><google-analytics-id></google-analytics-id><form-method></form-method><createdDate>2021-01-18</createdDate><createdTime>13:09:28</createdTime><status><status-message id = "2010" position = "1">Payment rejected by PSP</status-message></status><sign>257e89dffd3e6ff7db2fed0182ee54ef</sign><client-info language="gb" platform=""><mobile operator-id="10000" country-id="100"></mobile><email></email><customer-ref></customer-ref><device-id></device-id></client-info><additional-data><param name="linked_txn_id">1</param></additional-data></transaction><payment_status>Failed</payment_status><linked_transactions><transaction_details><id>1001001</id><status>Failed</status></transaction_details><transaction_details><id>1</id><status>Pending</status></transaction_details></linked_transactions><stored-card><card-id>61775</card-id><card-mask>501910******3742</card-mask><card-expiry>06/24</card-expiry><card-type>1</card-type></stored-card></root>', $sReplyBody);
    }
}
