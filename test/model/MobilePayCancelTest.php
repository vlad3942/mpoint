...
class MobilePayCancelTest extends baseAPITest
{
    ...
    public function testSuccessfulCancel()
    {
        ...
        $this->queryDB("INSERT INTO Log.Transaction_Tbl (id, typeid, clientid, accountid, countryid, pspid, extid, orderid, callbackurl, amount, ip, enabled, keywordid, sessionid) VALUES (1001001, 100, 113, 1100, 100, $pspID, '1515', '1513-005', '". $sCallbackURL. "', 5000, '127.0.0.1', TRUE, 1, 1)");
		...
		$this->queryDB("INSERT INTO Log.txnpassbook_Tbl (id,transactionid,amount,currencyid,requestedopt,performedopt,status) VALUES (104,1001001, 5000,208,". Constants::iCancelRequested. ",NULL,'done')");
		$this->queryDB("INSERT INTO Log.txnpassbook_Tbl (id,transactionid,amount,currencyid,requestedopt,performedopt,status,extref) VALUES (105,1001001, 5000,208,NULL,". Constants::iPAYMENT_CANCELLED_STATE. ",'inprogress',104)");
