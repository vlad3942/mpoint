						...
						if ($code >= 10)
						{
							...
							else
							{
								...
								if ($code == 3)
								{
									...
									$_OBJ_TXT = new TranslateText(array(sLANGUAGE_PATH . $obj_DOM->transfer[$i]->{'client-info'}["language"] ."/global.txt", sLANGUAGE_PATH . $obj_DOM->transfer[$i]->{'client-info'}["language"] ."/custom.txt"), sSYSTEM_PATH, 0, "UTF-8");
