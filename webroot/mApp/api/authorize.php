														...
														try
														{
														    if($obj_Elem["pspid"] > 0) {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    $iForeignExchangeId = $obj_TxnInfo->getExternalRef(Constants::iForeignExchange,$obj_TxnInfo->getPSPID());
                                                                    if($iForeignExchangeId !==null && empty($iForeignExchangeId) === false && sizeof($aStateId)>0) { $obj_Processor->getPSPInfo()->notifyForeignExchange($aStateId,$aHTTP_CONN_INFO['foreign-exchange']); }
