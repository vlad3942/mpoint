...
$obj_TxnInfo = new TxnInfo($iTxnID, Constants::iPURCHASE_VIA_WEB, $obj_mPoint->getClientConfig(), $obj_mPoint->getClientConfig()->getKeywordConfig()->getPrice(), -1, -1, $obj_MsgInfo->getAddress(), $obj_MsgInfo->getOperator(), "", $obj_mPoint->getClientConfig()->getLogoURL(), $obj_mPoint->getClientConfig()->getCSSURL(), $obj_mPoint->getClientConfig()->getAcceptURL(), $obj_mPoint->getClientConfig()->getDeclineURL(), $obj_mPoint->getClientConfig()->getCancelURL(), $obj_mPoint->getClientConfig()->getCallbackURL(), $obj_mPoint->getClientConfig()->getIconURL(), $obj_mPoint->getClientConfig()->getLanguage(),  $obj_mPoint->getClientConfig()->getMode(), $obj_mPoint->getClientConfig()->useAutoCapture(), EndUserAccount::getAccountID_Static($_OBJ_DB, $obj_mPoint->getClientConfig(), $obj_MsgInfo->getAddress() ), $obj_MsgInfo->getGoMobileID() );
