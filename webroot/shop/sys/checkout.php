...
$aTxnInfo = array("amount" => $_SESSION['obj_Info']->getInfo("order_cost") + $_SESSION['obj_Info']->getInfo("shipping_cost") );
...
if (count($aMsgCds) == 0)
{
	$obj_mPoint->logShippingInfo($_SESSION['obj_Info']->getInfo("shipping_cost") );
