			...
			<div>
				...
				<tr>
					<td class="submit" colspan="2">
						<button type="button" onclick="javascript:obj_Client.sendFormData(document.getElementById('send-otp') );" tabindex="12" title="login"><xsl:value-of select="labels/submit" /></button>
					</td>
				</tr>
				</table>
			</div>
