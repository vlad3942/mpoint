...
try
{
	...
	//
	$iStateID = $obj_mPoint->completeTransaction(Constants::iWANNAFIND_PSP, $_REQUEST['transact'], $_REQUEST['cardid'], ($_REQUEST['actioncode'] == 0 ? Constants::iPAYMENT_ACCEPTED_STATE : Constants::iPAYMENT_REJECTED_STATE), $_REQUEST);
	// Account Top-Up
