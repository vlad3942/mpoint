...
try
{
	...
	if ($iPSPStatus === Constants::iPAYMENT_ACCEPTED_STATE || $iPSPStatus === Constants::iPAYMENT_CAPTURED_STATE)
	{
		...
		$iStateID = $obj_PSP->completeTransaction(Constants::iMOBILEPAY_PSP, $obj_TxnData["external-id"], Constants::iMOBILEPAY , ($obj_TxnData->status["code"] >= 1000 ? Constants::iPAYMENT_ACCEPTED_STATE : Constants::iPAYMENT_REJECTED_STATE), 0, $iFee, array(var_export($obj_TxnData, true) ) );
