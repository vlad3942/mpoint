...
try
{
	...
	if ($iPSPStatus === Constants::iPAYMENT_ACCEPTED_STATE || $iPSPStatus === Constants::iPAYMENT_CAPTURED_STATE)
	{
        ...
        $sub_code = 0;
		$iStateID = $obj_PSP->completeTransaction(Constants::iMOBILEPAY_PSP, $obj_TxnData["external-id"], Constants::iMOBILEPAY , ($obj_TxnData->status["code"] >= 1000 ? Constants::iPAYMENT_ACCEPTED_STATE : Constants::iPAYMENT_REJECTED_STATE), $sub_code, $iFee, array(var_export($obj_TxnData, true) ) );
