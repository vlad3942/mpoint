...
$obj_DOM = simpledom_load_string(file_get_contents('php://input'));
    ...
    {
        $txnId = (int)$RS['ID'];
        $sqlA = "SELECT name, value FROM log" . sSCHEMA_POSTFIX . ".additional_data_tbl WHERE type='Transaction' and created >= '" . $RS['created'] . "' and externalid=" . $txnId." and value = '".$externalId."'";
