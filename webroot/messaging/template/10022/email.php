...
<head>
    ...
    <style>
        ...
        .content img { height: auto; min-height: 1px;max-width: 200px;margin-top: 15px;}
        #bodyTable{margin:0; padding:0; width:100% !important;}
        #bodyCell{margin:0; padding:0;}
        #bodyCellFooter{margin:0; padding:0; width:100% !important;padding-bottom:15px; background-color: #b9253b}
        ...
        a.blue-btn { background: #b9253b;display: inline-block;color: #FFFFFF; border-top:10px solid #b9253b;border-bottom:10px solid #b9253b; border-left:20px solid #b9253b;border-right:20px solid #b9253b;text-decoration: none;font-size: 14px; margin-top: 1.0em; border-radius: 3px 3px 3px 3px; background-clip: padding-box;padding: 0 20px}
                            ...
                            <tr>
                                <td valign="top" class="bodyContent">
                                    <p style="text-align: left">
                                        Please note that this booking is not ticketed.Your are one step away from
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                            <tr>
                                <td valign="top" width="100%">
                                    ...
                                    <h6 style="text-align:center;margin-top: 9px;">CUSTOMER RELATIONS OFFICER, P.O.BOX
                                        1755,</h6>
                                    <h6 style="text-align:center;">Ethiopian Airlines, Headquarters,</h6>
                                    <h6 style="text-align:center;"> Bole International Airport, Addis Ababa,
                                        Ethiopia</h6>
                                </td>
                            </tr>
                        </table>
